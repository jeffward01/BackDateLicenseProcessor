                    ...
                    if (workRec != null)
                    {
                        ...
                        if (track != null)
                        {
                            ...
                            if (track.Artist != null)
                            {
                                ...
                                var tempCopyRightHolder = new List<Snapshot_RecsCopyright>();
                                if (track.Copyrights != null)
                                {
                                    tempCopyRightHolder = track.Copyrights;
                                ...
                                if (tempCopyRightHolder.Count >= 1)
                                {
                                    track.Copyrights = tempCopyRightHolder;
                                }
                                    ...
                                    foreach (var copyRight in copyRights)
                                    {
                                        ...
                                        if (copyRightSamples != null)
                                        {
                                            foreach (var copyRightSample in copyRightSamples)
                                            {
                                                ...
                                                var localAquisitionLocaitonCodes =
                                                    copyRightSample.AquisitionLocationCodes;
                                                ...
                                                //save
                                                var savedSample =
                                                    _snapshotSampleRepository.SaveSampleSnapshot(copyRightSample);

                                                if (localAquisitionLocaitonCodes != null)
                                                {
                                                    foreach (
                                                        var localAquisitionLocaitonCode in localAquisitionLocaitonCodes
                                                    )
                                                    {
                                                        ...
                                                        _snapshotSampleAquisitionLocationCodeRepository
                                                            .SaveSampleAquisitionLocationCode(
                                                                localAquisitionLocaitonCode);
                                                    }
                                                }
                                                ...
                                                if (localClientSamples != null)
                                                {
                                                    ...
                                                    {
                                                        localClientSample.SnapshotSampleId =
                                                            savedSample.SnapshotSampleId;
                                        ...
                                        if (copyRightComposers != null)
                                        {
                                            foreach (var copyRightComposer in copyRightComposers)
                                            {
                                                ...
                                                if (composerOriginalPublishers != null)
                                                {
                                                    ...
                                                    {
                                                        //done
                                                        var composerOriginalPublisherKnownAs =
                                                            composerOriginalPublisher.KnownAs;
                                                                ...
                                                                composerOriginalPubliserAdmins)
                                                            {
                                                                ...
                                                                if (composerOpAdminAffiliations != null)
                                                                {
                                                                        ...
                                                                        composerOpAdminAffiliations)
                                                                    {
                                                                        ...
                                                                        {
                                                                            foreach (
                                                                                var affiliationBase in affiliationBases
                                                                            )
                                                                            {
                                                                                //assign FK
                                                                                affiliationBase
                                                    ...
                                                    foreach (var composerAffiliation in composerAffiliations)
                                                    {
                                                        ...
                                                        var savedComposedAffiliation =
                                                            _composerAffiliationRepository
                                                                .SaveComposerAffiliationSnapshot(
                                                                    composerAffiliation);
                                                        ...
                                                        )
                                                        {
                                                            ...
                                                            _composerAffiliationBaseRepository
                                                                .SaveComposerAffiliatioBasenSnapshot(
                                                                    composerAffiliationBase);
                                                        }
                                                    }
                                                }
                                            }
